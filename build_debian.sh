...
sudo LANG=c DEBIAN_FRONTEND=noninteractive apt install -t buster-backports zstd
...
pushd $FILESYSTEM_ROOT && sudo tar -I "zstd --long -10" -cf $OLDPWD/$FILESYSTEM_DOCKERFS -C ${DOCKERFS_PATH}var/lib/docker .; popd
